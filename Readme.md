...
**NOTE 3:** It appears that others are attempting to leverage the gibMacOS name to potentially deliver malware.  Valid copies of the script can always be retrieved [here on GitHub](https://github.com/corpnewt/gibMacOS).  For your safety, it is best to avoid any 3rd party rehosts.
